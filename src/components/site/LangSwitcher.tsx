...
export const LangSwitcher = ({ mobile = false }: { mobile?: boolean }) => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          className={`absolute min-w-[180px] bg-card border border-hairline z-50 animate-fade-in ${
            mobile
              ? "bottom-full left-0 mb-3"
              : "top-full mt-3 right-0 ltr:right-0 rtl:left-0 rtl:right-auto"
          }`}
        >
          {LANGS.map(l => (
            <button
